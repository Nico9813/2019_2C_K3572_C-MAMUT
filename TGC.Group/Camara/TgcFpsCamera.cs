...
namespace TGC.Examples.Camara
{
    ...
    public class TgcFpsCamera : TgcCamera
    {
        ...
        public void UpdateCamera(float elapsedTime,TGCVector3 pos,TGCVector3 director)
        {
            
            //Forward

            positionEye = pos + new TGCVector3(0,50,0);

          

            base.SetCamera(positionEye, positionEye + director);
        }
    }
}